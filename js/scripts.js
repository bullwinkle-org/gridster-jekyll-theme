$(document).ready(function () {
    ...
    if (cookieLayout != "") {
        $("#switch-style").attr("href", document.baseUri + "css/" + cookieLayout + ".css");
    }
    ...
    $(".switch div").click(function () {
        ...
        // adjust link here
        $("#switch-style").attr("href", document.baseUri + "css/" + id + ".css");
        setCookie("switch-style", id, 365);
    });

    var cookieColor = getCookie("color-change");
    if (cookieColor != "") {
        $("#color-change").attr("href", document.baseUri + "css/main_" + cookieColor + ".css");
    }
    ...
    $(".color-change img").click(function () {
        ...
        // adjust link here
        $("#color-change").attr("href", document.baseUri + "css/main_" + id + ".css");
